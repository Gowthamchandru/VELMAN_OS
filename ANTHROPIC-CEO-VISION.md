...
**Claude runs the cockpit.** Every module above is not a chart you read; it's a surface an agent operates. This is the upgrade that makes Velman OS worthy of a frontier-lab CEO — and the reason the lab can credibly say it runs on its own product.
