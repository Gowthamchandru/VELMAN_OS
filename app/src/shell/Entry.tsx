  ...
  return (
    <>
      <div
        ...
        style={{ backgroundImage: `image-set(url(${import.meta.env.BASE_URL}images/velman-hero.webp) type('image/webp'), url(${import.meta.env.BASE_URL}images/velman-hero.jpg) type('image/jpeg'))` }}
        aria-hidden="true"
      />
...
export function Welcome() {
  ...
  return (
    <main
      onMouseMove={onMove}
      className="entry-bg relative flex min-h-screen flex-col items-center justify-center gap-9 overflow-hidden px-6 py-[10vh] text-center lg:items-start lg:px-[7vw] lg:text-left"
    >
      <PhotoBackdrop />
