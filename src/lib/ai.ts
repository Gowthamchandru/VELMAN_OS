...
// just ask instead of clicking through pages. Builds a broad live snapshot of
// the entire app (still structured, never raw files), then chats over it.
// ============================================================================

// One reactive snapshot of the whole app, assembled from every module's hooks.
...
// Multi-turn chat over the whole-app snapshot, via the local Pro-backed server.
// (The persona/system prompt lives on the server, next to the Claude call.)
