...
// --- Formatting ---
// One canonical INR formatter for the whole finance module (defined in
// financeData so cash-flow and portfolio surfaces always render identically).
export { inr } from './financeData'
